      ...
      isGridView 
          ...
          : 'grid-cols-1'
                        ...
                        {pro.map((item, index) => (
                            ...
                            >
                                <Link href={`/data/details/${item.id}`} className={isGridView ? 'block w-full relative' : 'flex-shrink-0 w-1/3 sm:w-1/4'}>
                                    ...
                                    <div className={`flex items-center ${isGridView ? 'mt-2' : 'mt-auto'}`}>
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-500 text-sm mt-1">
                                                {new Date(item.create_at).toLocaleString('ko-KR', {timeZone: 'Asia/Seoul'})}
                                            </p>
                                        </div>
                                    </div>
                                </div>
