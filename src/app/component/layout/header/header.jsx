      ...
      <div className="flex items-center justify-between h-16">
        ...
        <div className="hidden md:flex items-center justify-center flex-grow">
          ...
          <div className="flex space-x-4 lg:space-x-8 lg:gap-16">
            ...
            <Link href="/admin" className="text-gray-800 font-semibold text-sm uppercase tracking-wide transition-colors duration-300 ease-in-out border-b-2 border-transparent focus:border-blue-600">
              Study
            </Link>
          </div>
        </div>
            ...
            <Link href="/profiles" onClick={handleMyPageClick}>
              <div className="flex items-center py-2 border-b border-gray-200 mb-2">
                <Image 
                  ...
                  width={32} 
                  height={32} 
                  className='w-8 h-8 rounded-full ring-2 ring-gray-300 mr-2'/>
